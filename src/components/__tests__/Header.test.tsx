...
describe("Header Component", () => {
  ...
  it("should have navigation with social links on the right side", () => {
    ...
    const githubLink = container.querySelector(
      'a[href="https://github.com/akshayaparida"]',
    );
  ...
  it("should have proper structure with home link and nav element", () => {
    const { container } = render(<Header />);
    ...
    // The nav element is inside the header
  ...
  it("should have multiple social links in nav", () => {
    ...
    // GitHub, LinkedIn, HuggingFace = 3 links
