...
export function buildSearchIndex(): SearchIndexItem[] {
  ...
  const staticCurricula = [
    ...
    },
    {
      ...
      keywords: [
        "Professional Communication CIA",
        "CSC-406",
        "6.0CSC04",
        "6.0 ODLCSC04",
        "pccia2025",
    ...
    },
    {
      ...
      desc: "CURAJ MSc CS official 6-unit curriculum: grammar & vocabulary, oral communication, listening & speaking, reading skills, technical & scientific writing, soft skills, resume building, and CIA question paper with solutions.",
